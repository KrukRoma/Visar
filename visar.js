document.addEventListener("DOMContentLoaded", () => {
  ...
  // Функціонал випадаючого меню
  const dropdownToggles = document.querySelectorAll(".dropdown-toggle");
  const dropdowns = document.querySelectorAll(".dropdown");

  // Функція для закриття всіх випадаючих меню
  ...
  // Обробник кліку для випадаючих меню
  ...
  mobileMenuLinks.forEach((link) => {
    link.addEventListener("click", () => {
      if (!link.classList.contains("mobile-dropdown-toggle") && !link.classList.contains("mobile-submenu-toggle")) {
        mobileMenu.classList.remove("active");
        document.body.classList.remove("mobile-menu-open");
      }
    });
  ...
  // Обробник кліку для мобільних випадаючих меню
  ...
  // Обробник кліку для мобільних підменю
